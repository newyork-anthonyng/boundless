...
import FittedText from '../packages/boundless-fitted-text/index.js';
...
class Container extends React.PureComponent {
    ...
    renderMainContent(route) {
        ...
        if (route.type === TYPE.COMPONENT) {
            sections.push(
                <Async key='component-page' childrenDidRender={window.Prism.highlightAll}>
            ...
            sections.push(
                ...
                (<Async key='utility-page' childrenDidRender={window.Prism.highlightAll}>
                    {import(`../packages/boundless-utils-${_.kebabCase(route.path)}/README.md`).then(
